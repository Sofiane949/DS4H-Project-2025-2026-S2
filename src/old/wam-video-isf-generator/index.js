/**
 * index.js
 * Point d'entrée principal du WAM ISF Visualizer.
 * Ce fichier définit la classe ISFVisualizerWAM conforme au standard WAM2.
 */
...
export default class ISFVisualizerWAM extends WebAudioModule {
    ...
    async createAudioNode(initialState) {
        // Enregistrement du processeur avec l'identifiant correct (com.project.isf)
        const processorCode = `
    ...
    async createGui() {
        ...
        gui.addEventListener('shader-change', async (e) => {
            ...
            if (!this.audioNode || !this.audioNode.renderer) return;
